...
>(
    ...
    return buildLineChart(data_mapped, dataSeries_mapped, seriesEntries, style, style.valueKey);
}
...
function buildLineChart(
    ...
    style?: LineChartStyleBase<string> & { brush?: LineChartBrushStyle<string> },
    valueKey?: string
): ExprType<UIComponentType> {
