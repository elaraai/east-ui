...
// ============================================================================
// Grid Item Style Type
// ============================================================================

/**
 * Grid item style type containing placement properties.
 *
 * @remarks
 * These properties control where a grid item is placed within the grid.
 * Note: content is defined separately in component.ts due to recursive type.
 *
 ...
 */
export const GridItemStyleType = StructType({
...
/**
 * Type representing grid item style values.
 */
export type GridItemStyleType = typeof GridItemStyleType;

/**
 * TypeScript interface for Grid.Item style options.
 *
 * @remarks
 * Use this interface when calling the Grid.Item function.
 *
 * @property colSpan - Number of columns the item spans
 * @property rowSpan - Number of rows the item spans
 * @property colStart - Starting column line
...
export interface GridItemStyle {
    ...
    colSpan?: SubtypeExprOrValue<StringType> | number;
    /** Number of rows the item spans */
    rowSpan?: SubtypeExprOrValue<StringType> | number;
    /** Starting column line */
    colStart?: SubtypeExprOrValue<StringType> | number;
    /** Ending column line */
    colEnd?: SubtypeExprOrValue<StringType> | number;
    /** Starting row line */
    rowStart?: SubtypeExprOrValue<StringType> | number;
    /** Ending row line */
    rowEnd?: SubtypeExprOrValue<StringType> | number;
}
