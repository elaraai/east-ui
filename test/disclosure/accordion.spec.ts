...
describeEast("Accordion", (test) => {
    ...
    test("creates accordion with items", $ => {
        ...
        $(assertEast.equal(accordion.style.hasTag("none"), true));
    });
    ...
    test("creates accordion with multiple enabled", $ => {
        ...
        $(assertEast.equal(accordion.style.hasTag("some"), true));
        $(assertEast.equal(accordion.style.unwrap("some").multiple.hasTag("some"), true));
        $(assertEast.equal(accordion.style.unwrap("some").multiple.unwrap("some"), true));
    });
    ...
    test("creates accordion with multiple disabled", $ => {
        ...
        $(assertEast.equal(accordion.style.unwrap("some").multiple.unwrap("some"), false));
    });
    ...
    test("creates collapsible accordion", $ => {
        ...
        $(assertEast.equal(accordion.style.hasTag("some"), true));
        $(assertEast.equal(accordion.style.unwrap("some").collapsible.hasTag("some"), true));
        $(assertEast.equal(accordion.style.unwrap("some").collapsible.unwrap("some"), true));
    });
    ...
    test("creates non-collapsible accordion", $ => {
        ...
        $(assertEast.equal(accordion.style.unwrap("some").collapsible.unwrap("some"), false));
    });
    ...
    test("creates enclosed variant accordion", $ => {
        ...
        $(assertEast.equal(accordion.style.hasTag("some"), true));
        $(assertEast.equal(accordion.style.unwrap("some").variant.hasTag("some"), true));
        $(assertEast.equal(accordion.style.unwrap("some").variant.unwrap("some").hasTag("enclosed"), true));
    });
    ...
    test("creates plain variant accordion", $ => {
        ...
        $(assertEast.equal(accordion.style.unwrap("some").variant.unwrap("some").hasTag("plain"), true));
    });
    ...
    test("creates subtle variant accordion", $ => {
        ...
        $(assertEast.equal(accordion.style.unwrap("some").variant.unwrap("some").hasTag("subtle"), true));
    });
